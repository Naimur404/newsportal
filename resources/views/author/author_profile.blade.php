                        ...
                        <form action="{{ route('author_edit_profile_submit') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <img src="{{ asset('admin_asset/uploads/default.png') }}" alt="" class="profile-photo w_100_p">
                                    @else
                                    <img src="{{ asset('admin_asset/uploads/'.Auth::guard('author')->user()->photo) }}" alt="" class="profile-photo w_100_p">
                                    @endif
