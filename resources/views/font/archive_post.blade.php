    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <h2>All Post Of:  {{ $final_date }}</h2>
                <nav class="breadcrumb-container">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Archive</a></li>
                        <li class="breadcrumb-item active" aria-current="page">All Post Of:  {{ $final_date }}</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="category-page-post-item">
                                ...
                                <div class="category">
                                    <a href="{{ route('sub_cat',$data->subCategory->id) }}"><span class="badge bg-success">{{ $data->subCategory->sub_category_name }}</span></a>
                                </div>
                                <h3><a href="{{ route('post_detail',$data->slug) }}">{{ $data->post_title }}</h3>
                                <div class="date-user">
                                    <div class="user">
                                        @if($data->author_id == 0)
